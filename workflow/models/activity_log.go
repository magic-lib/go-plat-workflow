...
type ActivityLogModel struct {
	...
	NodeSpanID   string    `gorm:"column:node_span_id;type:varchar(128);index:idx_proj_node_span;Default:''" json:"node_span_id"`
